...
be visualised with `read_and_plot_targets.py`:
...
| `target_generation.py`, `read_and_plot_targets.py` | Divertor target and vessel generation in the Kisslinger format for EMC3-EIRENE, and plotting of the generated surfaces |
