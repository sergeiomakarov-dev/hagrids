...
def magnetic_field_components(r, vartheta, varphi, B0, R0,
    ...
    Parameters:
        ...
        m, m1, m2 (int): Mode numbers for perturbations.
        iota_res, iota_res1, iota_res2 (float): Resonant iota parameters.
        A, A1, A2 (float): Amplitudes of perturbations.
        k (float): Scaling factor for perturbations.
        flag_form (int): Perturbation type: 0 (single) or 1 (dual).
        flag_toroildal (int): 0 (uniform toroidal field) or 1 (geometry-modified field).
        flag_type_A_fun (int): Type of perturbation function (0 or 1).
    ...
    """
    if flag_form not in [0, 1]:
        raise ValueError("Invalid value for flag_form. Must be 0 or 1.")
